...
// let n = Number(prompt("Hãy nhập vào 1 số n: "));
...
// let s = prompt("Nhập vào 1 chuỗi keyword tên người bạn muốn lấy email! ");
// users.forEach(element => {
//     if(s == element.first_name + element.last_name) {
...
countMerried = 0;
for (const element of users) {
    if(element.is_married == true) {
        countMerried++;
    }else if(element.is_married !== null) {
        countNotMerried++;
    }
}

console.log("Số người đã kết hôn là: "+ countMerried);
console.log("Số người chưa kết hôn là: "+ countNotMerried);
